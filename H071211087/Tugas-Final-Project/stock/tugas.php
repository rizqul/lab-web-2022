...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update sstock_tugas set nama='$nama', jenis='$jenis', merk='$merk', ukuran='$ukuran' where idx='$idx'");
        ...
        if ($updatedata){
            ...
            <meta http-equiv='refresh' content='1; url= tugas.php'/>  ";
    ...
    if(isset($_POST['hapus'])){
        ...
        $delete = mysqli_query($conn,"delete from sstock_tugas where idx='$idx'");
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($conn,"SELECT * from sstock_tugas order by nama ASC");
											$no=1;
	...
	<!-- modal input -->
			<div id="myModal" class="modal fade">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title">Masukkan Data Tugas Anda</h4>
						</div>
						<div class="modal-body">
							<form action="tmb_tugas.php" method="post">
								<div class="form-group">
									<label>Nama Tugas</label>
									<input name="nama" type="text" class="form-control" placeholder="Nama Tugas" required>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input name="merk" type="text" class="form-control" placeholder="Deadline Anda">
								</div>
								<!-- <div class="form-group">
									<label>Status</label>
									<input name="ukuran" type="text" class="form-control" placeholder="Status Anda">
								</div> -->
                                <div class="form-group">
									<label>Status</label>
                                    <select name="ukuran" class="custom-select form-control">
