...
<head>
    ...
    <title>Menu Mahasiswa - SH LMS</title>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Data Mahasiswa</span></li>
                            </ul>
                        </div>
                    </div>
										 ...
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
                                                    ...
                                                    <td><img style="width: 80px;" src="Mahasiswa.png"></td>
                                                ...
                                                <!-- The Modal -->
                                                    <div class="modal fade" id="edit<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <input type="text" id="foto" name="foto" class="form-control" value="<?php echo $p['foto'] ?>"> -->
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="tmb_brg_act.php" method="post">
								...
								<div class="form-group">
									<label>Nim</label>
									<input name="jenis" type="text" class="form-control" placeholder="NIM Anda">
								</div>
								<div class="form-group">
									<label>Alamat</label>
