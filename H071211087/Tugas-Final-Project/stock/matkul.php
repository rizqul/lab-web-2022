...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update sstock_matkul set nama='$nama', jenis='$jenis', merk='$merk', ukuran='$ukuran' where idx='$idx'");
    ...
    if(isset($_POST['hapus'])){
        ...
        $delete = mysqli_query($conn,"delete from sstock_matkul where idx='$idx'");
...
<head>
    ...
    <title>Mata Kuliah - SH LMS</title>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Daftar Mata Kuliah</span></li>
                            </ul>
                        </div>
                    </div>
                    <!-- <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right" style="color:black; padding:0px;">
                            <img src="/" width="220px" class="user-name dropdown-toggle" data-toggle="dropdown"\>
                        </div>
                    </div> -->
                </div>
            </div>
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											<tr>
												...
												<th>Deskripsi</th>
												<th>Dosen</th>
												<th>Waktu Mulai dan Berakhir</th>
												<th>Status</th>
												
												<th>Opsi</th>
											</tr></thead><tbody>
											<?php 
											$brgs=mysqli_query($conn,"SELECT * from sstock_matkul order by nama ASC");
											$no=1;
                                                ...
                                                <!-- The Modal -->
                                                    <div class="modal fade" id="edit<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <h4 class="modal-title">Edit  <?php echo $p['nama']?> - <?php echo $p['jenis']?></h4>
                                                    ...
                                                    <div class="modal fade" id="del<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                            <h4 class="modal-title">Hapus <?php echo $p['nama']?> - <?php echo $p['jenis']?></h4>
                                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            </div>
	...
	<!-- modal input -->
			<div id="myModal" class="modal fade">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title">Masukkan Data Matkul Anda</h4>
						</div>
						<div class="modal-body">
							<form action="tmb_matkul.php" method="post">
								<div class="form-group">
									<label>Nama</label>
									<input name="nama" type="text" class="form-control" placeholder="Nama Matkul Anda" required>
								</div>
								<div class="form-group">
									<label>Deskripsi</label>
									<input name="jenis" type="text" class="form-control" placeholder="Deskripsi Anda">
								</div>
								<div class="form-group">
									<label>Dosen</label>
									<input name="merk" type="text" class="form-control" placeholder="Dosen Anda">
								</div>
								<div class="form-group">
									<label>Waktu Mulai dan Berakhir</label>
									<input name="ukuran" type="text" class="form-control" placeholder="Inputan Anda">
								</div>
								<div class="form-group">
									<label>Status</label>
                                    <select name="stock" class="custom-select form-control">
									<option selected>Pilih Status</option>
									<option value="Tersedia">Tersedia</option>
									<option value="Tidak Tersedia">Tidak Tersedia</option>
                                    </select>
									<!-- <input name="stock" type="text" class="form-control" placeholder="Angkatan"> -->
								</div>
								<!-- <div class="form-group">
									<label>Satuan</label>
