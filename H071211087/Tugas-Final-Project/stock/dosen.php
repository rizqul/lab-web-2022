...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update sstock_dosen set nama='$nama', jenis='$jenis', merk='$merk', ukuran='$ukuran' where idx='$idx'");
        ...
        if ($updatedata){
            ...
            <meta http-equiv='refresh' content='1; url= dosen.php'/>  ";
    ...
    if(isset($_POST['hapus'])){
        ...
        $delete = mysqli_query($conn,"delete from sstock_dosen where idx='$idx'");
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($conn,"SELECT * from sstock_dosen order by nama ASC");
											$no=1;
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
                                                    ...
                                                    <td><img style="width: 50px;" src="Dosen.png"></td>
                                                ...
                                                <!-- The Modal -->
                                                    <div class="modal fade" id="edit<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <label for="ukuran">Nomor Telpon</label>
			...
			<div id="myModal" class="modal fade">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="tmb_dosen.php" method="post">
								...
								<div class="form-group">
									<label>NIP</label>
									<input name="jenis" type="text" class="form-control" placeholder="NIP Anda">
								</div>
								<div class="form-group">
									<label>Alamat</label>
									<input name="merk" type="text" class="form-control" placeholder="Alamat Anda">
								</div>
								<div class="form-group">
									<label>Nomor Telpon</label>
									<input name="ukuran" type="text" class="form-control" placeholder="Nomor Anda">
								</div>
								<!-- <div class="form-group">
