...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update sstock_kelas set nama='$nama', jenis='$jenis', merk='$merk', ukuran='$ukuran' where idx='$idx'");
    ...
    if(isset($_POST['hapus'])){
        ...
        $delete = mysqli_query($conn,"delete from sstock_kelas where idx='$idx'");
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($conn,"SELECT * from sstock_kelas order by nama ASC");
											$no=1;
	...
	<!-- modal input -->
			<div id="myModal" class="modal fade">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title">Masukkan Data Kelas Anda</h4>
						</div>
						<div class="modal-body">
							<form action="tmb_kelas.php" method="post">
								...
								<div class="form-group">
									<label>Kelas</label>
									<input name="jenis" type="text" class="form-control" placeholder="Kelas Anda">
								</div>
								<div class="form-group">
									<label>Jumlah Dosen</label>
									<input name="merk" type="text" class="form-control" placeholder="inputan Anda">
								</div>
								<div class="form-group">
