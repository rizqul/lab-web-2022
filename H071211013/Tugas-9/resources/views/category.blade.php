...
<body>
    <nav class="navbar">
        <div class="container-fluid">
            <span class="navbar-brand"><b> LARAVEL 2</b></span>
        </div>
    </nav>
    <div class="heading">
        <nav class="navbar navbar-expand-lg" style="background-color: #e3f2fd;">
            <div class="container-fluid">
                <!-- <a class="navbar-brand"><i>Data</i></a> -->
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                    <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#tambahDataCategory">
                        + <i>category</i> 
                    </button>
                    </li>
                </ul>
    ...
    @endif
        ...
        <table class="table">
            ...
            @foreach($data as $index => $item)
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-grid gap-2 d-md-block">
                            <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editCategoryUseQueryBuilder{{ $item->id }}" type="button">Edit</button>
                            <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteCategoryUseQueryBuilder{{ $item->id }}" type="button">Hapus</button>
                        </div>
                    </td>
                </tr>
                ...
                <div class="modal fade" id="deleteCategoryUseQueryBuilder{{ $item->id }}" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
                ...
                <div class="modal fade" id="editCategoryUseQueryBuilder{{ $item->id }}" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="tambahDataCategory" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalLabel">Tambah Category</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
