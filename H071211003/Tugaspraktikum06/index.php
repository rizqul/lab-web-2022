<?php
    ...
    if (isset($_POST ["bsave"])) {
        ...
        if($_GET['hal'] == "edit"){
            ...
            value ('$_POST[tnama]', '$_POST[tcategory]', '$_POST[tharga]', '$_POST[tstok]')");
    ...
    <div class="card-body">
        <form method= "post" action="">
            ...
            <div class= "form-group my-1">
                ...
                <select class= "form-control" name="tcategory" placeholder= "Select category product here!">
