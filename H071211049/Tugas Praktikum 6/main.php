    ...
    <table class="table">
      ...
      <tbody>
        ...
        ?>
          ...
          <td scope="">
            <a href="main.php?op=edit&id=<?php echo $id?>"><button type="button" class="btn btn-warning">Ubah</button></a>
            <a href="main.php?op=delete&id=<?php echo $id?>"><button type="button" class="btn btn-danger">Hapus</button></a>
          </td>
          </tr>
