...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
    <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#addProduct" type="button">Tambah Kategori</button>

    <div class="modal fade" id="addProduct" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalLabel">Edit Data Produk</h5>
