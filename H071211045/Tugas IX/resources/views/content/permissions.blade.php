<div class="tab bg-dark permissions-tab rounded">
    <div class="container my-2 d-flex flex-row">
        <div class="col align-middle label">
            Permissions
            <i class="bi bi-database-fill-lock ms-2"></i>
        </div>
        <div class="col-100">
            <button type="submit" class="btn btn-skin btn-add" id="add-permission">
        ...
        <table class="table table-bordered m-auto w-100 h-100">
            ...
            <tbody>
                ...
                @forelse ($permissions as $data)
                    <tr>
                        <th scope="row">{{ ($permissions ->currentpage()-1) * $permissions ->perpage() + $loop->index + 1 }}</th>
                        <td>{{ $data->name }}</td>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="text-center text-beige">No Permission Stated.</td>
                    </tr>
                @endforelse
