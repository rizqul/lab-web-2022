...
<div class="card w-50 input-data" id="modal">
    ...
    <form action="{{ route('store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row mt-2">
            ...
            <div class="col-9 m-2"><input type="text" class="form-control @error('book_name') is-invalid @enderror"
                    placeholder="Book Name" name="book_name"></div>
        ...
        <div class="row">
            ...
            <div class="col-9 m-2"><input type="text" class="form-control @error('author') is-invalid @enderror"
                    placeholder="Author" name="author"></div>
        ...
        <div class="row">
            ...
            <div class="col-9 m-2"><input type="text" class="form-control @error('category') is-invalid @enderror"
                    placeholder="Category" name="category"></div>
        ...
        <div class="row">
            ...
            <div class="col-9 m-2">
                <select class="form-select" aria-label="Default select example" name="favorable">
        ...
        <div class="row m-3">
            <button type="submit" name="save" class="btn btn-primary" id="save-button">Add Data</button>
        </div>
    </form>
</div>
