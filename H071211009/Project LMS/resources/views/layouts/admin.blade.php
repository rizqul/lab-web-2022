...
<head>
	...
	<title>KARASUNO HIGH SCHOOL</title>
		...
		<header class="header">
			<div class="logo-container">
				<a href="/admin/index" class="logo">
					<img src="{{asset('admin/img/karasuno_logo.png')}}" width="40" height="35" alt="Porto Admin" />
				</a>
				<p class="logo pt-1	">
					<b>KARASUNO HIGH SCHOOL</b>
				</p>
				...
				<div id="userbox" class="userbox">
					<a href="#" data-toggle="dropdown">
						<figure class="profile-picture">
							<img src="{{asset('admin/img/'. Auth::user()->foto)}}" alt="Joseph Doe" class="rounded-circle" width="40px" height="40px"
								data-lock-picture="img/default.jpg" />
						</figure>
						...
						<div class="sidebar-widget widget-tasks">
							...
							<div class="widget-content">
								<ul class="list-unstyled m-0">
									<li><a href="{{Route('userIndex')}}">Data Admin</a></li>
