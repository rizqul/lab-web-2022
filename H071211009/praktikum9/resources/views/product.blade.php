...
<body>
	...
	<div class="mx-auto">
					...
					<div class="modal-body">
						...
						<form action="/product/add" method="POST">
							...
							<div class="mb-3 row">
								...
								<div class="col-sm-10">
									<select class="form-select" aria-label="Default select example" name="category_id" value="" required>
										<option selected>Open this select menu</option>
		...
		<div class="card">
			<div class="card-header text-white">Products Data</div>
			<div class="card-body">
				<table class="table">
					<thead>
						<tr>
					...
					<div class="modal-body">
						...
						<form action="/product/add" method="POST">
							...
							<div class="mb-3 row">
								<label for="seller_id" class="col-sm-2 col-form-label">Seller ID</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="seller_id" name="seller_id" value="{{ $item->seller_id }}" required />
								</div>
							</div>
							<div class="mb-3 row">
								<label for="category_id" class="col-sm-2 col-form-label">Category ID</label>
...
<script>
	$('.delete').click(function() {
		...
		.then((willDelete) => {
			if (willDelete) {
				window.location = "/product/delete/" + idMhs + ""
