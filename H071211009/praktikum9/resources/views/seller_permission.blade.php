...
<body>
	...
	<div class="mx-auto">
		<h1 style="padding-top:100px;">
			<center>SELLER PERMISSION</center>
		</h1>
		<hr>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form action="/seller_permission/add" method="POST">
							@csrf
							<div class="mb-3 row">
								<label for="name" class="col-sm-2 col-form-label">Seller Id</label>
								<div class="col-sm-10">
								<select class="form-select" aria-label="Default select example" name="seller_id" value="" required>
							...
							<div class="mb-3 row">
								<label for="description" class="col-sm-2 col-form-label">Permission Id</label>
								<div class="col-sm-10">
								<select class="form-select" aria-label="Default select example" name="permission_id" value="" required>
										<option selected>Open this select menu</option>
		...
		<div class="card">
			<div class="card-header text-white">Seller Permission Data</div>
			<div class="card-body">
				<table class="table">
					<thead>
						<tr>
					...
					<tbody>
						...
						<div class="modal fade" id="staticBackdrop{{ $item->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title" id="staticBackdropLabel">Add Seller Permission</h5>
										<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
									</div>
									<div class="modal-body">

										<!-- untuk memasukkan data -->
										<form action="/seller_permission/update/{{ $item->id }}" method="POST">
											@csrf
											<div class="mb-3 row">
												<label for="name" class="col-sm-2 col-form-label">Seller Id</label>
												<div class="col-sm-10">
